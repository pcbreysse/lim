'''
Primary module for interacting with LIMpy package, modeled heavily off the
functionality of the hmf package.
'''
...
class LineModel(object):
    '''
    An object containing all of the relevant quantities of a LIM model.
    ...
    def dndL(self):
        ...
        TODO:
        Add ability to compute dndL for L(M) model
        '''
    ...
    def bofM(self):
        ...
        return 1.- A*nu**a/(nu**a+dc) + B*nu**b + C*nu**c
    ...
    def Pk_twohalo(self):
        ...
        if self.do_onehalo:
            if self.model_type=='LF':
                print "One halo term only available for LF models"
